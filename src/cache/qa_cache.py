...
from src.cache.cache_policy import FUZZY_THRESHOLD as _POLICY_FUZZY_THRESHOLD
from src.cache.cache_policy import slots_compatible as _slots_compatible
...
from src.rag.wiki_rag import embedder as _bge
...
class QACache:
    ...
    def __init__(
        ...
        # 绝不再参与"是否丢弃缓存"的判定。
        try:
            from src.rag import config as _rag_config
